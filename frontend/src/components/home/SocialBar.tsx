  ...
  return (
    <div className="absolute left-2 top-[45vh] flex flex-col items-center space-y-4 z-50">
      ...
      <a href="https://www.instagram.com/edcell.mait/" target="_blank" rel="noopener noreferrer">
        <FontAwesomeIcon icon={faInstagram} className="text-gray-800 dark:text-white text-3xl hover:text-pink-500 transition duration-300" />
      </a>
      <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer">
        <FontAwesomeIcon icon={faYoutube} className="text-gray-800 dark:text-white text-3xl hover:text-red-600 transition duration-300" />
      </a>
      <a href="https://chat.whatsapp.com/Hj9nvbZKece10kf0RyfbmX" target="_blank" rel="noopener noreferrer">
        <FontAwesomeIcon icon={faWhatsapp} className="text-gray-800 dark:text-white text-3xl hover:text-green-500 transition duration-300" />
      </a>
      <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">
        <FontAwesomeIcon icon={faTwitter} className="text-gray-800 dark:text-white text-3xl hover:text-blue-500 transition duration-300" />
      </a>
    </div>
  );
};
