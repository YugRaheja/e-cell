...
const pastEvents = [
  ...
  },
  {
    ...
    date: '2025-03-18',
    time: '11:00 AM',
    location: '11 Block,Seminar Hall, MAIT Campus',
  ...
  },
  {
    ...
    time: '10:00 AM',
    location: 'MAIT Campus',
    description: 'As part of alumni meetup, we are hosting an exclusive startup expo-a free platform for startups, companies, and VcS To showcase their innovation and expertise. ',
